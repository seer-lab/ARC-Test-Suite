...
# System variables
_ROOT_DIR = "/Users/kelk/workspace/ARC-Test-Suite/arcTestArea/05/"
_MAX_MEMORY_MB = 2000
_MAX_CORES = 2
...
_PROJECT_PREFIX = "Buffer,BufferNotify,Producer,Consumer,PCThreads"  # Comma separated fully-qualifying class names or package prefixes
_PROJECT_TESTSUITE = "BufferTest"
_PROJECT_COMPILE = "compile"
_PROJECT_CLASSPATH = _PROJECT_CLASS_DIR + ":" + _PROJECT_TEST_DIR
...
_CONTEST_RUNS = 5
_CONTEST_TIMEOUT_SEC = 12 # Aim for around x2-3 desirable performance
...
_EVOLUTION_REPLACE_WITH_BEST_PERCENT = 100

# Dynamic ranking window (number of generations to consider)
_DYNAMIC_RANKING_WINDOW = 10
