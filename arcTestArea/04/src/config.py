...
# System variables
_ROOT_DIR = "/Users/kelk/workspace/ARC-Test-Suite/arcTestArea/04/"
_MAX_MEMORY_MB = 2000
_MAX_CORES = 2
...
_PROJECT_PREFIX = "AllocationVector,AllocTest,TestThread1"  # Comma separated fully-qualifying class names or package prefixes
_PROJECT_TESTSUITE = "AllocationTest"
...
_CONTEST_RUNS = 5
_CONTEST_TIMEOUT_SEC = 480 # Aim for around x2-3 desirable performance
