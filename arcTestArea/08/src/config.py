...
# System variables
_ROOT_DIR = "/Users/kelk/workspace/ARC-Test-Suite/arcTestArea/08/"
_MAX_MEMORY_MB = 2000
_MAX_CORES = 2
...
_PROJECT_PREFIX = "Buffer,BufWriter,Checker,SyncWriter,Writer"  # Comma separated fully-qualifying class names or package prefixes
_PROJECT_TESTSUITE = "BufWriterTest"
...
_CONTEST_RUNS = 5
_CONTEST_TIMEOUT_SEC = 4 # Aim for around x2-3 desirable performance
