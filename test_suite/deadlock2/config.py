...
_PROJECT_DIR = _ROOT_DIR + "input/deadlock2/"
...
_PROJECT_PREFIX = "Deadlock2"  # Comma separated fully-qualifying class names or package prefixes
_PROJECT_TESTSUITE = "Deadlock2Test"
