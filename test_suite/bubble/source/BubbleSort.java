...
public class BubbleSort
{
    ...
    // ---------------------------
    // BUG: Starting multiple bubble sorts on one array causes a data race
    //      One solution is to join() a thread after it is created
    public void Sort()
    {
        synchronized(sort_lock)
        {
            for(int i =0;i < size; i++) // DK: was ++i // running 'size' times
            {
